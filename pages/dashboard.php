...
<head>
    ...
    <style>
        ...
        .modal-skin-primary .btn-close {
            filter: invert(1) brightness(200%);
        }

        .modal-skin-primary .modal-body {
            background: #eef6ff;
        }
        ...
        .modal-skin-success .btn-close {
            filter: invert(1) brightness(200%);
        }

        .modal-skin-success .modal-body {
            background: #ecfdf3;
        }
        ...
        .modal-skin-warning .btn-close {
            filter: none;
        }

        .modal-skin-warning .modal-body {
            background: #fff9db;
        }
        ...
        .modal-skin-info .btn-close {
            filter: invert(1) brightness(200%);
        }

        .modal-skin-info .modal-body {
            background: #e7f8fd;
        }
        ...
        .modal-skin-purple .btn-close {
            filter: invert(1) brightness(200%);
        }

        .modal-skin-purple .modal-body {
            background: #f3e8ff;
        }
    </style>
</head>
